...
📖 Использование
Загрузка документов
На главной странице перетащите файлы (PDF/DOCX) в область Drag‑and‑Drop или выберите через диалог.

Наблюдайте за прогрессом загрузки и индексации.

После завершения документ появится в списке «Uploaded Documents».
...
Результаты отобразятся карточками с подсветкой совпадений и релевантностью.

Используйте пагинацию для просмотра всех результатов.
...
Elasticsearch – за мощный поисковый движок.
